...
class SchedulerTest {
    ...
    @Test
    void initializeFIRST_oneOrderIsNotFeasible_returnOrderTrackListWithZeroAnswerForNotFeasibleOrder() throws InvocationTargetException, IllegalAccessException {
        //given
        scheduler.setTask(Task.FIRST);
        when(orders.get(0)).thenReturn(Order.builder()
                .orderId("order-1")
